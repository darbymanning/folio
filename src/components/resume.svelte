...
>
  ...
  >
    <p class="text-lg">
      Senior software engineer and designer shipping fast, accessible products with Svelte, React
      and TypeScript. Leads architecture, design systems and delivery across web and native.
    </p>
